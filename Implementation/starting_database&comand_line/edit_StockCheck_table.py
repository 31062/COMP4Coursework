...
def edit_stockcheck_data(data,field):
...
def edit_stockcheck_main():
    edit_stockcheck_display()
    field, data = edit_stockcheck_input()
    edit_stockcheck_data(data,field)
