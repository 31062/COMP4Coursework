...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{U:\git\COMP4Coursework\Design\pdf imagesflowdiagram_new_stock.pdf}
    \caption{flowdiagram for adding new stock} \label{fig:new stock flowchart}
\end{figure}


\begin{figure}[H]
    \includegraphics[width=\textwidth]{U:\git\COMP4Coursework\Design\pdf images\flowdiagram_use_stock.pdf}
    \caption{The result of executing the print() function} \label{fig:print_function_result}
\end{figure}


\begin{figure}[H]
    \includegraphics[width=\textwidth]{U:\git\COMP4Coursework\Design}
    \caption{The result of executing the print() function} \label{fig:print_function_result}
\end{figure}
